...
import InstantAppointmentsForm from "../components/InstantAppointmentForm";
      ...
      <div className="results">
        {filteredData.map((item, index) => (
          <div className="result-card" key={index}>
            ...
            <InstantAppointmentsForm itemname={item.name} itemspecialization={item.specialization} />
          </div>
        ))}
      </div>
    </div>
